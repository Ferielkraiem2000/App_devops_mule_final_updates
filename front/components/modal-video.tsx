...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      ...
      {/* Video thumbnail */}
      <button
        className="group relative flex items-center justify-center rounded-2xl focus:outline-none focus-visible:ring focus-visible:ring-teal-200"
        onClick={() => {
          setModalOpen(true);
        }}
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-br before:from-gray-900 before:via-teal-500/20 before:to-gray-900">
          <Image
          ...
          <span className="relative flex items-center gap-3">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#5bc8c4" />
                  <stop offset={1} stopColor="#5bc8c4" stopOpacity=".72" />
                </linearGradient>
              </defs>
            </svg>
